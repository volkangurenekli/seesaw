...
const SVGComponent = (props) => (
  <div className="gender gender--female">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.8 95.8">
      ...
      <path
        className="body"
        d="M88,48.21a40,40,0,1,1-40-40,40,40,0,0,1,40,40Z"
      ></path>
      <path
        className="eyes"
      ...
      ></path>
      <path
        className="mouth mouth--sad mouth--active"
        d="M66.55,64.67a24.29,24.29,0,0,0-37.8,0"
      ></path>
      <path
      ...
      <path
        ...
        d="M67.18,57.37a24.3,24.3,0,0,1-37.81,0"
      ></path>
    </svg>
  </div>
);
